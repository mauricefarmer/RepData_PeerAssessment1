...
The interval with the highest average steps is interval **`r avInter$interval`** which has an average of **`r format(avInter$average.steps, digits= 2, nsmall = 2)`** steps.
